...
<html>
	...
	<body>
		...
		<?php
			...
			if($cnt==1)
			{
				echo "<h3 style='padding-left: 20px;'>Frequent Flier No.: ".$frequent_flier_no."&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;Mileage: ".$mileage." points</h3><br>";
			}
		...
		<img src="images/Cust-Homepage.webp" width="100%" height="74.68%">
		</div>
	<footer>
